    ...
    def _format_module_practicals_section(module_breakdown: Dict[str, Any], css_class: str,
        ...
        if isinstance(practicals_structured, dict) and practicals_structured:
            ...
            parts.append(f"""<div class="detail-item {css_class}" style="padding-left:40px;font-size:0.85em;color:#666;">
                ...
                <span class="detail-hours">{week_count} sessions/week @ {first_session_weekly:.1f}h each = {first_session_weekly * week_count:.1f}h/week × {config.TEACHING_WEEKS_PER_SEMESTER} weeks × {first_session_rate}x rate = {(first_session_weekly * week_count * config.TEACHING_WEEKS_PER_SEMESTER * first_session_rate):.1f}h</span>
            </div>""")
