...
def run_validation_pipeline(year_data) -> Dict[str, Any]:
    """
    Run full validation and return structured results.
    ...
    Returns:
        Dictionary with validation results including:
            ...
            - module_issues: Issues per module
            - staff_issues: Issues per staff member
